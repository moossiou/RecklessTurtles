...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        public void Shoot()
        {
            StopCoroutine("ShootLightning");
            StartCoroutine("ShootLightning");
        }

        public IEnumerator ShootLightning()
        {
            ...
            while (enabled == true)
            {
                ...
                if (Physics.Raycast(playershoot.weapon.transform.position, playershoot.weapon.transform.forward, out hit, playershoot.currentWeapon.range, mask))
                {
